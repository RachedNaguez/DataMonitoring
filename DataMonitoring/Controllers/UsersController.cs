    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            var users = await _userManager.Users
                .Select(user => new UserViewModel { Id = user.Id, UserName = user.UserName, Email = user.Email, Departement = user.Departement, Roles = _userManager.GetRolesAsync(user).Result })
                .ToListAsync();
