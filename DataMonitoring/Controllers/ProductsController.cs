...
namespace DataMonitoring.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [Authorize(Permissions.Products.Create)]
        public async Task<IActionResult> Create([Bind("Id,Name,Category,Quantity,Price")] Product product)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Permissions.Products.Edit)]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Category,Quantity,Price")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
