    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customer != null ? 
                          ...
                          Problem("Entity set 'CustomersContext.Customer'  is null.");
        }
        ...
        [Authorize(Permissions.Customers.Create)]
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Mobile")] Customer customer)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Permissions.Customers.Edit)]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,Mobile")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
